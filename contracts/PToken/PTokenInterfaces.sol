...
contract PTokenStorage {
     ...
     */
    uint public constant protocolSeizeShareMantissa = 0; // 0%, disabled

    /*
    * @notice First MINIMUM_LIQUIDITY minted tokens gets locked on address(0) to prevent totalSupply being 0
    */
